...
export default class PaginationBoxView extends Component {
  ...
  render() {
    ...
    return (
      ...
      <ul className={containerClassName} style={{
        display: "flex",
        listStyle:"none",  
        paddingLeft: "15px",
        paddingRight: "15px",
        ...
        <li className={previousClasses} style={{paddingLeft: "15px",
      paddingRight: "15px", }}>
          <a
        ...
        <li className={nextClasses} style={{paddingLeft: "15px",
      paddingRight: "15px"}}>
          <a
